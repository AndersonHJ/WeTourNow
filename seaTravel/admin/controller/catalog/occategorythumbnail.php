...
class ControllerCatalogOccategorythumbnail extends Controller
{
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
        /* End */
        ...
        foreach ($results as $result) {
            ...
            $data['categories'][] = array(
                ...
                'edit'                  => $this->url->link('catalog/occategorythumbnail/edit', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, 'SSL'),
            );
        }
        /* End */
        ...
        $data['sort_name'] = $this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
        $data['sort_sort_order'] = $this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    protected function getForm() {
        ...
        $data['action'] = $this->url->link('catalog/occategorythumbnail/edit', 'token=' . $this->session->data['token'] . '&category_id=' . $this->request->get['category_id'] . $url, 'SSL');

        $data['cancel'] = $this->url->link('catalog/occategorythumbnail', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        if (isset($this->request->post['image']) && is_file(DIR_IMAGE . $this->request->post['thumbnail_image'])) {
