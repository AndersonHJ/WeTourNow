...
class ControllerModuleOcslideshow extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);			
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$data['link_to_module'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'], 'SSL');
		$data['link_to_banner'] = $this->url->link('module/ocslideshow/form', 'token=' . $this->session->data['token'], 'SSL');	
		...
		$this->response->setOutput($this->load->view('module/ocslideshow/config.tpl', $data));
	}
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		if (isset($this->request->get['page'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
		
		
		$data['insert'] = $this->url->link('module/ocslideshow/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/ocslideshow/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('module/ocslideshow/update', 'token=' . $this->session->data['token'] . '&ocslideshow_id=' . $result['ocslideshow_id'] . $url, 'SSL')
			);
		...
		$data['sort_name'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		$this->response->setOutput($this->load->view('module/ocslideshow/ocslideshow_list.tpl', $data));		
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['ocslideshow_id'])) { 
			$data['action'] = $this->url->link('module/ocslideshow/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/ocslideshow/update', 'token=' . $this->session->data['token'] . '&ocslideshow_id=' . $this->request->get['ocslideshow_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('module/ocslideshow', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('module/ocslideshow/ocslideshow_form.tpl', $data));
	}
