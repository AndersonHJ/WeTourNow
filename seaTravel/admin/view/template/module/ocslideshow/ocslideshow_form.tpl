          ...
          <div class="row">
            <div class="col-sm-2">
              <ul class="nav nav-pills nav-stacked" id="module">
                ...
                <li><a href="#tab-module<?php echo $ocslideshow_image['key']; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-module<?php echo $ocslideshow_image['key']; ?>\']').parent().remove(); $('#tab-module<?php echo $ocslideshow_image['key']; ?>').remove(); $('#module a:first').tab('show');"></i> <?php echo $tab_module . ' ' . $module_row; ?></a></li>
                <?php $module_row++; ?>
                <?php } ?>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-module<?php echo $ocslideshow_image['key']; ?>">
                  <ul class="nav nav-tabs" id="language<?php echo $ocslideshow_image['key']; ?>">
                    ...
                    <li><a href="#tab-module<?php echo $ocslideshow_image['key']; ?>-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                    <?php } ?>
                  </ul>
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-module<?php echo $ocslideshow_image['key']; ?>-language<?php echo $language['language_id']; ?>">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-heading<?php echo $ocslideshow_image['key']; ?>-language<?php echo $language['language_id']; ?>"><?php echo $entry_title; ?></label>
						
                        <div class="col-sm-10">
                          <input type="text" name="ocslideshow_image[<?php echo $image_row; ?>][ocslideshow_image_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($ocslideshow_image['ocslideshow_image_description'][$language['language_id']]) ? $ocslideshow_image['ocslideshow_image_description'][$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-heading<?php echo $ocslideshow_image['key']; ?>-language<?php echo $language['language_id']; ?>"><?php echo $entry_subtitle; ?></label>
						
                        <div class="col-sm-10">
                          <input type="text" name="ocslideshow_image[<?php echo $image_row; ?>][ocslideshow_image_description][<?php echo $language['language_id']; ?>][sub_title]" value="<?php echo isset($ocslideshow_image['ocslideshow_image_description'][$language['language_id']]) ? $ocslideshow_image['ocslideshow_image_description'][$language['language_id']]['sub_title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="ocslideshow_image[<?php echo $image_row; ?>][link]" value="<?php echo isset($ocslideshow_image['link']) ? $ocslideshow_image['link'] : ''; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" />
					</div>
				  </div>
				<div class="form-group">
...
function addModule() {
	...
	html += '        <div class="col-sm-10"><textarea name="ocslideshow_image[' + token + '][ocslideshow_image_description][<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description' + token + '-language<?php echo $language['language_id']; ?>"></textarea></div>';
	html += '      </div>';
	html += '    </div>';
	<?php } ?>
	...
	html += '        <div class="col-sm-10"><input type ="text" name="ocslideshow_image[' + token + '][link]" placeholder="<?php echo $entry_link; ?>" id="input-link' + token + '-language<?php echo $language['language_id']; ?>"/></div>';
	html += '      </div>';
