            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php if ($layout_module['position'] == 'top_search') { ?>
                    <option value="top_search" selected="selected"><?php echo $text_top_search; ?></option>
                    <?php } else { ?>
                    <option value="top_search"><?php echo $text_top_search; ?></option>
                    <?php } ?>
                    
                    
                    <?php if ($layout_module['position'] == 'top_menu') { ?>
                    <option value="top_menu" selected="selected"><?php echo $text_top_menu; ?></option>
                    <?php } else { ?>
                    <option value="top_menu"><?php echo $text_top_menu; ?></option>
                    <?php } ?>
                    
                    <?php if ($layout_module['position'] == 'top_container') { ?>
                    <option value="top_container" selected="selected"><?php echo $text_top_container; ?></option>
                    <?php } else { ?>
                    <option value="top_container"><?php echo $text_top_container; ?></option>
                    <?php } ?>
                    
                    <?php if ($layout_module['position'] == 'mid_footer') { ?>
                    <option value="mid_footer" selected="selected"><?php echo $text_mid_footer; ?></option>
                    <?php } else { ?>
                    <option value="mid_footer"><?php echo $text_mid_footer; ?></option>
                    <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="top_container"><?php echo $text_top_container; ?></option>';
    html += '    <option value="mid_footer"><?php echo $text_mid_footer; ?></option>';
    html += '    <option value="top_search"><?php echo $text_top_search; ?></option>';
    html += '    <option value="top_menu"><?php echo $text_top_menu; ?></option>';
