...
class ControllerModuleOctabproductslider extends Controller {
	public function index($setting) {
		...
		*/
			...
			$cate = $this->model_catalog_category->getCategory(25);
			$name = strip_tags($cate['name']);
        	$name = str_replace('&nbsp;', ' ', $name);
        	$description = html_entity_decode($cate['description']);
        	//$description = strip_tags($cate['description']);
        	$description = str_replace('&nbsp', '', $description);
        	$image = strip_tags($cate['image']);
			...
			$cate = $this->model_catalog_category->getCategory(17);
			$name = strip_tags($cate['name']);
        	$name = str_replace('&nbsp;', ' ', $name);
        	$description = html_entity_decode($cate['description']);
        	$description = str_replace('&nbsp', '', $description);
			...
			$cate = $this->model_catalog_category->getCategory(18);
			$name = strip_tags($cate['name']);
        	$name = str_replace('&nbsp;', ' ', $name);
        	$description = html_entity_decode($cate['description']);
        	$description = str_replace('&nbsp', '', $description);
			...
			$cate = $this->model_catalog_category->getCategory(20);
			$name = strip_tags($cate['name']);
        	$name = str_replace('&nbsp;', ' ', $name);
        	$description = html_entity_decode($cate['description']);
        	$description = str_replace('&nbsp', '', $description);
			...
			$cate = $this->model_catalog_category->getCategory(33);
			$name = strip_tags($cate['name']);
        	$name = str_replace('&nbsp;', ' ', $name);
        	$description = html_entity_decode($cate['description']);
        	$description = str_replace('&nbsp', '', $description);
