...
<div class="before-mid-slider">
	<h1> CUSTOMIZE GET AWAY</h1>
		...
		<?php foreach($productTabslider as $productTab){ ?>
			<div id="tab_<?php echo $productTab['id']; ?>" class="tab_content">
				...
				<div class="owl-demo-tabproduct">
					...
					<div id = "newnivo" class="nivo-caption">
						<div class="ima">
						<a href="#"><img alt="plazathems.com" src="image/<?php echo $productTab['image']?>"></a>
						</div>
						<div class="banner7-content slider-4 hidden-xs ">
								<h1 class="title"><span><?php echo $productTab['name']; ?></span></h1>
								<h2 class="sub-title"><?php echo $productTab['description'];?></h2>
