<div id="cart">
  ...
  <ul class="dropdown-menu pull-right">
    <?php if ($products || $vouchers) { ?>
        ...
        <li>
          ...
          <div class="product-details">
            ...
            <button type="button" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>">remove</button>
    ...
    <li>
      ...
      <div class="actions">
        <a href="<?php echo $checkout; ?>"><strong><?php echo $text_checkout; ?></strong></a>
      </div>
    </li>
    <?php } else { ?>
    <li>
