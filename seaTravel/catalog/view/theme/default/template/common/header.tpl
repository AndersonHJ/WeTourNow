...
<link href="catalog/view/theme/tt_primave/stylesheet/stylesheet.css" rel="stylesheet" />
<link href="catalog/view/theme/tt_primave/stylesheet/animate.css" rel="stylesheet" />
<link href="catalog/view/theme/tt_primave/stylesheet/opentheme/hozmegamenu/css/custommenu.css" rel="stylesheet" />
<link href="catalog/view/theme/tt_primave/stylesheet/opentheme/css/owl.carousel.css" rel="stylesheet" />
<script src="catalog/view/javascript/jquery/elevatezoom/jquery.elevatezoom.js" type="text/javascript"></script>
<script src="catalog/view/javascript/opentheme/ocslideshow/jquery.nivo.slider.js" type="text/javascript"></script>
<link href="catalog/view/javascript/jquery/css/jquery-ui.css" rel="stylesheet" media="screen" />
<link href="catalog/view/theme/tt_primave/stylesheet/opentheme/oclayerednavigation/css/oclayerednavigation.css" rel="stylesheet">
<link href="catalog/view/theme/tt_primave/stylesheet/opentheme/opcajaxlogin/css/opcajaxlogin.css" rel="stylesheet">
                        ...
                        <ul class="menu dropit">
                            <li class="dropit-trigger"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><span class="account-dropdown"><?php echo $text_account; ?></span> <span class="caret"></span></a>
                              <ul class="menu_link ul-account">
                                ...
                                <li><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><span class="hidden-xs hidden-sm hidden-md"><?php echo $text_shopping_cart; ?></span></a></li>
