<footer>
  ...
  <div class="footer-static-top">
    <div class="container">
      ...
      <div class="row">
        <div class="col-1 col-sm-6 col-md-3 col-sm-6 col-xs-12">
          <a href="#"><img alt="logo-footer" src="/image/catalog/logo-footer.jpg"></a>
        ...
        <div class="col-sm-6 col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="content-contact">
            <ul>
              ...
              <li><i class="fa fa-mobile"></i><?php echo $telephone; ?></li>
