			  ...
			  <form name="subscribe" id="subscribe">
				  <div class="subscribe-content">
                    ...
                    <div class="input-box">
						...
						<input type="hidden" value="" name="subscribe_name" id="subscribe_name" placeholder="<?php echo $entry_name; ?>">
                    </div>
					<div class="actions-subcribe">
                        <button class="button" onclick="email_subscribe()">
                            <span><?php echo $entry_button; ?></span>
                        </button>
						<?php if($option_unsubscribe) { ?>
							<button class="button" onclick="email_unsubscribe()">
